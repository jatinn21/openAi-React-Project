...
function LandingPage() {
  ...
  return (
    <>
      ...
      <section className="leftSide center">
        <p className="company__logo">logo</p>
        <p className="company__name">Board.</p>
        <p className="company__socialMedia">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="45"
      ...
      <section className="rightSide center">
        <div className="signin__Form">
          ...
          <form className="formDetails">
            ...
            <p className="forminput">
              ...
              <input type="password" value="helloWorld" readOnly />
            </p>
          ...
          <div className="registeredLine center">
